...
import 'package:story_app/models/models.dart';
...
class _StoryDetailScreenState extends State<StoryDetailScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        context.read<StoryProvider>().fetchStoryDetail(widget.storyId).then((
          _,
        ) {
          final story = context.read<StoryProvider>().selectedStory;
          if (story != null && story.lat != null && story.lon != null) {
            _getPlaceAddress(story.lat!, story.lon!);
          }
        });
  ...
  Future<void> _getPlaceAddress(double lat, double lon) async {
    try {
      ...
      // Jika gagal, biarkan _address null (atau set pesan error)
    }
  }
  ...
  void dispose() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      storyProvider.clearSelectedStory();
    });
    super.dispose();
  }
      ...
      appBar: AppBar(
        ...
        leading: Container(
          ...
          child: IconButton(
            ...
            onPressed: () => context.goNamed('stories'),
          ),
        ),
        actions: [
          Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (story.lat != null && story.lon != null)
                                      _buildLocationMap(story, localization),
  ...
  Widget _buildLocationMap(Story story, AppLocalizations localization) {
    return Padding(
                ...
                markers: {
                  Marker(
                    ...
                    infoWindow: InfoWindow(
                      title: story.name,
                      snippet:
                          _address ?? 'Lat: ${story.lat}, Lon: ${story.lon}',
                    ),
                  ),
                },
