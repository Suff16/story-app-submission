...
class _StoryListScreenState extends State<StoryListScreen>
  ...
  void initState() {
    ...
    Future.microtask(() {
      if (mounted) {
        context.read<StoryProvider>().fetchStories(refresh: true);
      }
    });
  }
  ...
  void _onScroll() {
    ...
    if (currentScroll >= maxScroll - 100) {
      ...
      if (storyProvider.hasMore && !storyProvider.isLoadingMore) {
          ...
          body: Consumer<StoryProvider>(
            builder: (context, storyProvider, child) {
              ...
              return RefreshIndicator(
                onRefresh: () => storyProvider.fetchStories(refresh: true),
                color: colorScheme.primary,
                child: ListView.builder(
                  controller: _scrollController,
                  // FIX PAGINATION: Item hanya +1 jika hasMore true
                  itemCount:
